...
<!--      <div class="panel-heading"><h4>List of Users&nbsp;&nbsp;&nbsp;<span>(192)</span></h4></div>
-->      <div class="panel-body">
        <div class="row">
          <div class="left">
            <h4>LIST OF USERS&nbsp;&nbsp;&nbsp;<span>(192)</span></h4>
          </div>
        ...
        <div class="modal-body">
          <div class="clearfix mb15 top-info">
            <div class="col-md-8">
              ...
              <p><strong>Designation:&nbsp;</strong>User</p>
          ...
          <ul class="user-badges list-unstyled row">
            ...
            <li class="col-xs-4 Profile text-center"> <i class="ion ion-ios-body text-primary"></i> <strong>32</strong>
