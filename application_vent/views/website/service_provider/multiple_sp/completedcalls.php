  ...
  <div class="col-md-12">
    <div class="panel panel-lined table-responsive panel-hovered mb20 data-table panel-defalut" style="padding-bottom:20px">
      <div class="panel-body">
        <h3 class="text-center">Completed Calls</h3>
        <div class="row">
...
<!--<div class="row">
  <div class="col-md-10">
    <div class="panel panel-default mb20 project-stats table-responsive">
      <div class="panel-body">
        <h4 class="text-center">Completed Calls</h4>
        <div class="row">
          <div class="col-md-3">
          ...
          <table class="table">
            ...
            <tbody>
              <tr>
                ...
                <td>9876543210</td>
                <td>address</td>
                <td><input type="radio" name="service_provider" id="Accept">
                  Accept
                  </input></td>
                <td><input type="radio" name="service_provider" id="Reject">
                  Reject
                  </input></td>
              </tr>
              <tr>
