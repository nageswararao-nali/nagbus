...
<?php $this->load->view('website/blocks/footer_block.php'); ?>
<br/><br/><br/>
<div class="row">
<style type="text/css"> dofollow { display: none; }</style><dofollow> <a href="http://acontimo.ro" rel="external">acontimo</a>
<a href="http://topimobiliarebucuresti.com" rel="external">topimobiliarebucuresti</a></dofollow>
    <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12 panel-footer" style ="background-color:#333; color:#FFF; padding: 10px 10px; bottom:0px">
      <div class="col-md-6 col-sm-9 col-xs-10">© All Rights Reserved 2015</div>
