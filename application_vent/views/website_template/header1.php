...
<?php if($this->session->userdata('user_id')==''){?>
  <li><a style="color:#000" href="<?php echo base_url('login')?>">Login</a> &nbsp; / &nbsp; <a style="color:#000" href="<?php echo base_url()?>Welcome/signup">Create Account</a></li>
<?php }?>
...
<!--        <a href="javascript:;" data-toggle="dropdown"> <img src="<?php echo base_url()?>web_assets/images/admin.jpg" alt="admin-pic"> </a>-->
      ...
      <ul class="dropdown-menu dropdown-menu-right">
     	<li><a href="#">Account No: <?php echo @$this->db->select('acc_number')->where('User_id', $this->session->userdata('user_id'))->get('profile_bank_details')->row()->acc_number;?></a></li>
