<div class="row">
  <div class="col-md-8">
          ...
          <div class="col-md-12">
            <div class="panel panel-default mb20 mini-box panel-hovered">
              ...
              <div class="panel-footer clearfix panel-footer-sm panel-footer-success">
                <h4 class="mt0 mb0 text-center">Products</h4>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="col-md-12">
            <div class="panel panel-default mb20 mini-box panel-hovered">
              ...
              <div class="panel-footer clearfix panel-footer-sm panel-footer-primary">
                <h4 class="mt0 mb0 text-center">Sellers</h4>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="col-md-12">
            <div class="panel panel-default mb20 mini-box panel-hovered">
              ...
              <div class="panel-footer clearfix panel-footer-sm panel-footer-danger">
                <h5 class="mt0 mb0 text-center">Wholesalers/Manufacture</h5>
              </div>
            </div>
          </div>
        </div>
    ...
    <div class="row">
      <div class="col-md-offset-4 col-md-2 prod-title-left text-center">
      ...
      <div class="col-md-2 prod-title-left text-center">
        <button type="button" class="btn btn-pink btn-rounded waves-effect">Go to E-shop</button>
      </div>
    </div>
  </div>
  <div class="col-md-4 text-center"><img class="imgthumb" src="<?=base_url()?>images/e-commerce.jpg" alt="flight" style="height:230px; width:280px" /> </div>
</div>
