    ...
    <div class="page-auth" id="register_container" style="display:none;">
      <div class="auth-container">
        ...
        <div class="form-container"> <?php echo form_open('Welcome/register','method="post" id="register_form" class="form-horizontal"')?>
          ...
          <div class="form-group">
            <select class="form-control" name="country" id="ccountry" onChange="getStates(this.value)" required>
          ...
          <div class="form-group">
            <select class="form-control" name="country" required>
                <option value="0" selected="selected">Please Select Your State</option>
                <?php foreach($roles as $row) { ?>
                <option value="<?=$row->role_id?>"><?=$row->role_name?></option>
              <?php } ?>
            </select>
          ...
          <div class="form-group">
            <select class="form-control" name="country" required>
                <option value="0" selected="selected">Please Select Your District</option>
                <?php foreach($roles as $row) { ?>
                <option value="<?=$row->role_id?>"><?=$row->role_name?></option>
              <?php } ?>
            </select>
          ...
          <div class="form-group">
            <select class="form-control" name="country" required>
                <option value="0" selected="selected">Please Select Your City</option>
                <?php foreach($roles as $row) { ?>
                <option value="<?=$row->role_id?>"><?=$row->role_name?></option>
              <?php } ?>
            </select>
          ...
          <div class="form-group">
            <input type="text" readonly="readonly" class="form-control" name="pincode" placeholder="Your Pincode" required/>
          </div>
          <!-- <div class="form-group">
