        ...
        $("#wallet_withdraw").validate({
            ...
            messages: {
                amount: {
                   ...
                   // max: "Minmum wallet amount should be 100"
                },
                account_number: {
    ...
    <div class="col-md-10 col-md-offset-1">
        <div class="panel panel-default panel-hovered panel-stacked mb30">
            ...
            <div class="panel-body">
                <div class="row">
                    <div class="col-md-12">
                        <form class="form-horizontal" name="wallet_withdraw" id="wallet_withdraw" action="<?php echo base_url(); ?>user/wallet_withdraw_otp" method="post">
