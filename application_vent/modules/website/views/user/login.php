...
<!--      <form class="form-horizontal" action="javascript:;" id="login">-->
        <div class="form-group">
          <input type="text" class="form-control" placeholder="Email ID Or Mobile Number" autofocus name="username" id="username">
        </div>
        <div class="form-group">
          <input type="password" class="form-control" placeholder="Password" name="password" id="password">
		  
		   <input type="hidden" class="form-control" value="0"  name="usertype" id="usertype">
        </div>
       <!-- <div class="form-group">
...
/*$(document).ready(function() {
    ...
    $("#loginForm").validate({
                    ...
                    messages: {
						   ...
						   username:{required:"Please enter valid Email id or Mobile Number"},
