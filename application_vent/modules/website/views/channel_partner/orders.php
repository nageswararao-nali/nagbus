...
<h4>Your Order Details:</h4>
 ...
 <div class="ibox-content">	
				...
				<?php echo form_open(base_url() . 'channel_partner/Orders', array('class' => 'form-horizontal', 'id' => 'Orders')); ?>
			  ...
			  <div class="form-group">
                ...
                <span class="input-group-addon"><i class="ion ion-calendar"></i></span> </div>
				 ...
				 <a href="<?= base_url() ?>channel_partner/Orders"> <input type="button" name="reset" id="reset" value="Show All"></a>
                  </div>
                </div>
              </div>
