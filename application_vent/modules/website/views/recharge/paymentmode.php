      ...
      <div class="panel-body">
        <div class="row">
		  ...
		  ///
			...
			<p class="well-sm">Total Payment to be made : <b>RS. <?php echo $this->session->userdata('rcAmount');?></b></p>
			...
			<div class="text-left col-md-12">
				...
				echo $amount."&nbsp;-&nbsp;".$wallet_amount."&nbsp;=&nbsp;".($amount-$wallet_amount);
				}else{
					echo $wallet_amount."&nbsp;-&nbsp;".$amount."&nbsp;";
					}
				}
				else
				{
				...
				{
					?>
				<p class="well-sm">Remaining Balance&emsp;<?php echo ($amount>$wallet_amount)?"0":($wallet_amount-$amount);?></p><?php } ?>
				</div>
			</div>
			...
			?>
				<div  class="text-left col-md-12">
			<p class="well-sm">Total Payment to be made(6): <b>RS. <?php echo $this->session->userdata('rcAmount')."&nbsp;-&nbsp;".$netcomm?>(Commision 	)&emsp;=&nbsp;<?=$this->session->userdata('rcAmount') - $netcomm?></b></p>
			<input type="hidden" name="payamount" id="payamount" value="<?php echo ($amount > $wallet_amount)?($amount-$wallet_amount):($amount);?>">
			<input type="hidden" name="walamount" id="walamount" value="1">
			</div>
			<div class="text-left col-md-12">
