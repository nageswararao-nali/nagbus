...
else
{
	...
	{
		//$sub_txt = "In order to continue avail services, Please pay Subscription Amount INR ".$subscrptions['agent_subscription_amt']. 'and your wallet will  refilled with INR '.$subscrptions['subscription_wallet_amt'];
	}
}
//check whether Agent pays Subscription Amount or not
?>
