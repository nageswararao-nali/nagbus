...
<h4>Your Order Details:</h4>
 ...
 <div class="ibox-content">	
				...
				<?php echo form_open(base_url() . 'agent/Creditorders', array('class' => 'form-horizontal', 'id' => 'Orders')); ?>
                ...
                <div class="row">
                  <div class="col-lg-3">
                   <select  class="form-control" name="mark_as_credit_user" id="mark_as_credit_user">
									...
									<option value="1">Mark As Credit</option>
			  ...
			  <div class="form-group">
                ...
                <span class="input-group-addon"><i class="ion ion-calendar"></i></span> </div>
				 ...
				 <a href="<?= base_url() ?>agent/Creditorders"> <input type="button" name="reset" id="reset" value="Show All"></a>
			...
			<?php echo form_open(base_url() . 'agent/Creditordersstatus', array('class' => 'form-horizontal', 'id' => 'Ordersst')); ?>
