...
class Dashboard extends CI_Controller {
    ...
    function __construct() {
        ...
        $this->load->database();
        $this->load->model(array('general_model', 'users_model', 'wallet_history', 'operators_model', 'service_provider', 'smd','Va_Commisions_model','categories_model'));		
    ...
    public function Commission() {
		...
		$data['comm_detils'] = $this->Va_Commisions_model->get_comm_details();
