<style>.spl_offer{	display:none;	}</style><div class="wrapper wrapper-content animated fadeInRight">
  <div class="ibox float-e-margins">
    ...
    <div class="ibox-content">
      ...
      </form>	  	  <hr>	  <table class="table table-hover">            <thead>              <tr class="text-center">                <th>Mode</th>                                <th>Channel Partner</th>				<th>SMD</th>                <th>Term 1 year</th>				<th>Term 1 %</th>                 <th>Term 2 year</th>				<th>Term 2 %</th>				<th>Term 3 %</th>                <th>Actions</th>              </tr>            </thead>            <tbody class="tblCategories2">			</tbody>			</table>
    </div>
  </div>
</div>
<script>
