<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-sm-6">
        ...
        <ul class="breadcrumb">
            ...
            <li class="active"><strong>Service Providers</strong></li>
        </ul>
    </div>
</div>
...
<div class="wrapper wrapper-content animated fadeInRight">
    <div class="row white-bg">
        <?php echo form_open(base_url() . 'dashboard/service_providers/', array('class' => 'form-horizontal', 'id' => 'addServiceProviders')); ?>
        ...
        <div class="col-lg-6">
            <div class="ibox-content">
                ...
                <div class="form-group">
                    <label class="col-lg-4 control-label">Home Repairs*</label>
                    <div class="col-lg-8">
                        <?php echo form_dropdown("home_repairs", $home_repairs, "", "class='form-control' id='home_repairs'"); ?>
                    </div>
                </div>
                        ...
                        <tbody>
                            <?php foreach ($user_details as $data) { ?>
                                <tr>
                                    ...
                                    <td><a href="<?php echo base_url()?>dashboard/update_service_provider/<?php echo $data['user_id']; ?>">Edit</a> - <a href="#" class="btn btn-white btn-sm deleteAction" title="Click me to delete"><i class="fa fa-times"></i> Delete</a></td>
                                </tr>
                            <?php } ?>
                        </tbody>
                    </table>
