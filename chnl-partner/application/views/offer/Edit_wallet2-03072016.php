...
<div class="wrapper wrapper-content animated fadeInRight" ng-controller="supportmatrixCtrl">
            ...
            <hr>
			 ...
			 <div class="form-group">
                ...
                <div class="col-lg-8">
				  ...
				  <textarea style="width:600px; height:180px" name='wallet_offers'><?php echo $data[0]->wallet_offers;?></textarea>
 ...
 <div class="form-group">
                ...
                <div class="col-lg-8">
				  ...
				  <textarea style="width:600px; height:180px" name='wallet_offers_user'><?php echo $data[0]->wallet_offers_user;?></textarea>
 ...
 <div class="form-group">
                ...
                <div class="col-lg-8">
				  ...
				  <textarea style="width:600px; height:180px" name='wallet_offers_user_under_agent'><?php echo $data[0]->wallet_offers_user_under_agent;?></textarea>
