				...
				?>
						...
						<div class="form-group">
                            ...
                            <div class="col-lg-6">
                                ...
                                <input type="radio" name="avl_options" value="1"> They can utilize the amount after adding minimum balance <input type="text" placeholder="" class="" name="min_wallet_amoun" id="min_wallet_amoun" value='' style='width:120px'>	 <br>
								<input type="radio" name="avl_options" value="2" > They can use amount directly<br>
								<input type="radio" name="avl_options" value="3" >	Must send the app link to a friend to utilize the amount ( after downloading the app by the friend)<br>
								<input type="radio" name="avl_options" value="4" > Get ‘y’ discount on ‘z’ product with below rules<br>
