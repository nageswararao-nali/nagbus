			   ...
			   <div class="ibox-content">	
				...
				?>
						 ...
						 <div class="form-group col-lg-6">
                           ...
                           Add ( INR )<input type="number" any  placeholder=""  name="offer_amount" id="offer_amount" value='' style='width:120px'>Amount 1st time to user wallet
						...
						<div class="form-group">
                            ...
                            <div class="col-lg-6">
                                ...
                                <input type="checkbox" name="avl_options[]" value="1"> They can utilize the amount after adding minimum balance <input type="number" any  placeholder="" class="" name="min_wallet_amoun" id="min_wallet_amoun" value='' style='width:120px'>	 <br>
            ...
            <tbody class="flat_currency_table">
              <tr style="background-color:#9CC">
                ...
                <div class="col-lg-8">
				 ...
				 to 
                  ...
                  <input type="text" id="endDate" name="end_date"  style="width:100px">
							 ...
							 <div class="form-group">
				 <div  class="col-lg-4" ><label class="col-lg-12 control-label"><span style='color:green'>AGENT</span>  Offer Description(Display in Front End)</label></div>
                ...
                <div class="col-lg-8">
				 ...
				 <textarea style="width:600px; height:180px" name='joining_offers'><?php echo $data[0]->joining_offers;?></textarea>
                 
                  </div>	
					
	</div>			
	 <div class="form-group">
				 <div  class="col-lg-4" ><label class="col-lg-12 control-label"><span style='color:green'>USER</span> Offer Description(Display in Front End)</label></div>
                ...
                <div class="col-lg-8">
				 ...
				 <textarea style="width:600px; height:180px" name='joining_offers_user'><?php echo $data[0]->joining_offers_user;?></textarea>
                 
                  </div>	
					
	</div>			
	 <div class="form-group">
				 <div  class="col-lg-4" ><label class="col-lg-12 control-label"><span style='color:green'>USER UNDER AGENT</span> Offer Description(Display in Front End)</label></div>
                ...
                <div class="col-lg-8">
				 ...
				 <textarea style="width:600px; height:180px" name='joining_offers_user_under_agent'><?php echo $data[0]->joining_offers_user_under_agent;?></textarea>
...
<?php
			 ...
			 <tr id="a<?php echo $value["id"]?>" >
               <td><?php echo $str?> </td>
                ...
                <td><a href='javascript:;' custdata="<?php echo $value["id"]?>" class="deleteme123">Delete</a></td>
              </tr>
