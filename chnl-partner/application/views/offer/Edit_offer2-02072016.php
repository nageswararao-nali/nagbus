            ...
            <tbody class="flat_currency_table">
              <tr style="background-color:#9CC">
                ...
                <div class="col-lg-8">
				 ...
				 to 
                  ...
                  <input type="text" id="endDate" name="end_date"  style="width:100px">
							 ...
							 <div class="form-group">
				 <div  class="col-lg-4" ><label class="col-lg-12 control-label">Offer Description(Display in Front End)</label></div>
                ...
                <div class="col-lg-8">
				 ...
				 <textarea style="width:600px; height:180px" ></textarea>
