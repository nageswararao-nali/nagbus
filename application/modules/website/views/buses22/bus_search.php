                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            <div class="input-group"> <i class="input-group-addon fa fa-map-marker"></i>
                                ...
                                <input type="hidden" id="tags_val" name="cities_val" class="form-control">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            <div class="input-group"> <i class="input-group-addon fa fa-map-marker"></i>
                                ...
                                <input type="hidden" id="tags2val" name="cities2val" class="form-control">
                            </div>
                        </div>
                    </div>
...
?>
        ...
        ?>
                    ...
                    <select class="form-control selectVal" name="selectBpoint" data-bid="<?=$travel['id']?>" value="Boarding Point" >
