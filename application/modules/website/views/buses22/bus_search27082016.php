<div class="row navbar-default navbar">
    <div class="col-md-4">
     <a href="#" style="line-height:60px"> MODIFY</a>  </div>
  <div class="col-md-4" style="text-align:center">
<p>  <span> Hyderabad </span><i class="fa fa-arrow-right" aria-hidden="true"></i> <span>  Visakhapatnam </span></p>
<p>26-Aug-2016 </p>
  </div>
  
  <div class="col-md-4 text-right ">
  <a href="#"  style="line-height:60px"> RETURN</a> 
  </div>
	   ...
	   foreach($jsonresult['availableTrips'] as $travel):
			...
			foreach($travel['droppingTimes'] as $key => $val){
				if(isset($val['bpId'])){
					...
					$dropingPoints[$val] = array($travel['boardingTimes']['bpName'], getTime($travel['boardingTimes']['time']));
				}
				//echo "<br>";
			}
			endforeach;
...
?>
            ...
            <button type="button" class="btn btn-danger waves-effect pull-right mySeatVal"  style="margin-top:12px" data-bussid="<?=$travel['id']?>">Select Your Seats</button>
                                        ...
                                        <div class="row">
                                            <div class="col-md-8">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-3">
                                                        <div style="background-color:#ff0000; border:1px solid #C0C0C0; width:20px; height:18px;" class="left"></div>
                    ...
                    <select class="form-control" name="selectBpoint" data-bid="<?=$travel['id']?>" value="Boarding Point" required>
				...
				//echo "<br>";
                    ...
                    ?>
                                                   ...
                                                   <form action="/buses/payment" method="post">
													...
													<input type="hidden" name="src" id="src" value="<?=$from?>">
                                                    <input type="hidden" name="srcid" id="srcid" value="<?=$srcid?>">
                                                    <input type="hidden" name="dest" id="dest" value="<?=$to?>">
