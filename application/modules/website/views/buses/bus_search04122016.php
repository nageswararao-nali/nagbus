                                ...
                                <div class="col-md-12">
                                    <div class="panel panel-success panel-hovered panel-stacked mb30">
                                        ...
                                        <?=getTime($travel['arrivalTime'])?></h4> Duration :
                                            ...
                                            <div class="col-md-2"> <span> Available Seats 123 :  <b style="font-size:18px;"><?=$travel['availableSeats']?></b></span>
...
?>												<?=$dataFare+$markup;?>
        ...
        ?>
                                                ...
                                                <input type="hidden" name="tot" id="tot<?=$travel['id']?>" value="<?=$finalmarkup;?>"/>
