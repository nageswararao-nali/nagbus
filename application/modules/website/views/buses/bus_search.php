...
?>												<?=$dataFare+$markup;?>
            ...
            <button type="button" class="btn btn-danger waves-effect pull-right mySeatVal"  style="margin-top:12px" data-bussid="<?=$travel['id']?>" data-buspricemarkup="<?=$dataFare+$markup?>">Select Your Seats</button>
            </a> </h4>
                                            </div>
        ...
        ?>
                    ...
                    ?>
								...
								<input type="hidden" name="onward_org_amt"  value="<?=$dataFare?>">
                            ...
                            <?php
								 ...
								 ?>
								           <div class="row travels" data-stime="<?=$travel['departureTime']?>" data-price="<?=round($dataFare+$markup)?>">
                                        <div class="col-md-12">
                                            <div class="panel panel-success panel-hovered panel-stacked mb30">
                                                <center>
...
?>
                    ...
                    <script>
                        ...
                        $(document).on("click", ".mySeatVal", function () {
							...
							var buspricemarkup = $(this).data("buspricemarkup");
