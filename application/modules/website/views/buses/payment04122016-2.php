    ...
    <div class="col-md-8">
        <div class="panel mb20 panel-default panel-hovered">
            <div class="panel-body">
                <!--<form action="/mybus_live/buses/onword_booking_process" method="post">-->
                <form action="/buses/proceed" method="post">
...
if( $commision_amt[0]->mark_comm_type == "INR" )
				{
					echo $markup = $commision_amt[0]->mark_comm_value;
				}
				else
				{
					echo $markup = $dataFare*$commision_amt[0]->mark_comm_value/100;
				}		
