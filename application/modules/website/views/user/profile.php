      ...
      <div class="tab-pane active" id="tab-linearrow-one">
        ...
        <div class="row" style="margin-top:20px">
          ...
          <div class="col-md-4">
			...
			?>
            <input type="text" class="form-control"  name="fullname" id="fullname" value="<?php echo @$user_info->name;?>" readonly="readonly"/>
          </div>
          <div class="col-md-4">
        ...
        <div class="row" style="margin-top:20px">
          ...
          <div class="col-md-4">
            ...
            <input type="text" class="form-control" id="geocomplete123" value="<?php echo @$user_info->city_name;?> , <?php echo @$user_info->district_name;?>"    readonly="readonly"/>
        ...
        <div class="row" style="margin-top:20px">
          ...
          <div class="col-md-4">
            ...
            <input   type="text" class="form-control" name="postalcode" id="postalcode" value="<?php echo @$user_info->pincode;?>"  readonly="readonly">
          </div>
        </div>
...
$('.edit-profile').click(function(){
	...
	$('#tab-linearrow-one').find('#postalcode').attr("readonly","readonly");
	$('#tab-linearrow-one').find('#geocomplete123').attr("readonly","readonly");
	$('#tab-linearrow-one').find('#emailid').attr("readonly","readonly");
	$('#tab-linearrow-one').find('#mobileno').attr("readonly","readonly");	
