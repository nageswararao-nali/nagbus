    ...
    <div class="col-md-8 col-md-offset-1">
        <div class="panel panel-default panel-hovered panel-stacked mb30">
            ...
            <div class="panel-body">
                <div class="row">
                    <div class="col-md-12">
                        <form class="form-horizontal" name="add_funds" id="add_funds" action="<?php echo base_url(); ?>user/add_funds" method="post" enctype="multipart/form-data" >
                            ...
                            <div class="form-group">        
                                <div class="col-sm-offset-4 col-sm-6">
                                    <div class="radio">
                                        <label><input type="radio" value="1" name="ptype" id="bank" class="ptype">&nbspBank&emsp;&emsp;</label>
                                        <label><input type="radio"  name="ptype"  value="2" checked  id="payu" class="ptype">&nbspPayu</label>
                                    </div>
                                </div>
                            </div>
