...
$wallet_amount = $this->users->get_wallet_amount($user_id,$role_id);
			   ...
			   if( $this->session->userdata('rcAmount') >  $netamt && true )
			   {
				?>
				<div class="text-left col-md-12" style='color:red'>
				Please Pay pending amount INR . <?php echo abs($wallet_amount);?> to avail the services.
				</div
				<?php				
			   }
			   else
