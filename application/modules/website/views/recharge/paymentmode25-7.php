        ...
        <div class="row">
		  ...
		  ///
			...
			<div class="text-left col-md-12">
				...
				<p class="well-sm"><?php if($amount>$wallet_amount){ echo $amount."&nbsp;-&nbsp;".$wallet_amount."&nbsp;-&nbsp;".$netcomm."&emsp;=&nbsp;".($amount-$wallet_amount);}else{ echo $wallet_amount."&nbsp;-&nbsp;".$amount."&nbsp;+&nbsp;".$netcomm;}?>&emsp;<button <?php echo $waldis;?> type="submit" class="btn btn-info" id="walproceed">Pay Now</button></p>
				<p class="well-sm">Reamining Balance&emsp;<?php echo ($amount>$wallet_amount)?"0":($wallet_amount-$amount+$netcomm);?></p>
				</div>
			</div>
			<div class="text-left col-md-12">
