        ...
        <div class="panel-body"> <?php echo form_open('recharge/proceed','id="recForm" method="post" autocomplete="off"')?>
          ...
          <div class="row">
            ...
            <div class="col-md-2">
			  ...
			  <div id="acc_number" style="display:none">Account Number<input type="text" name="postpaid_acc_no" value="" placeholder='Post paid Bill Account Number'></div>
            </div>
            ...
            ?>
             ...
             <input type="checkbox" name="mark_credit" value="1" class="credit">
          ...
          <div class="form-group">
           ...
           <div class="form-group homepage-rech ">
              ...
              <input type="text" class="form-control Comments"  name="mark_credit_text" style="display:none" placeholder="Enter Your Comments">
            </div>
