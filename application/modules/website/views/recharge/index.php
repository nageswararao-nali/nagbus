    ...
    <div class="col-sm-12 homepage-form">
      <div class="panel mb20 panel-default panel-hovered">
        ...
        <div class="panel-body"> <?php echo form_open('recharge/proceed','id="recForm" method="post" autocomplete="off"')?>
          ...
          <div class="form-group">
            <input type="text" class="form-control fetch_network num_only" onkeyup="checkplans()" name="mobile_no" id="mobile_no"  placeholder="Mobile no" autofocus required>
          </div>
          
          
          <div class="form-group">
            <select id="operator_code"  class="form-control operators" name="operator" style="width: 100%" required>
              <option value="" disabled="disabled">Select Operator</option>
            </select>
          </div>
         
          <div class="form-group postpaid">
            <select class="form-control operators2" name="operator" style="width: 100%" required>
              <option value="" disabled="disabled">Select Operator</option>
            </select>
          </div>
          ...
          <div class="form-group">
            <input type="text" class="form-control rcAmount rcamountplan " placeholder="Recharge Amount" name="rcAmount" id="rcAmount">
			<br>
			<span id="pplan"></span>
          </div>
          
           <div id="acc_number" style="display:none" class="form-group">
<input type="text" name="postpaid_acc_no" class="form-control" value="" placeholder='Post paid Bill Account Number'></div>
...
$('.rcamountplan').keyup(function(){
	...
	amount = $(this).val();
	$.ajax({
            url: "http://laabus.com/Recharge/getOffersplan",
			data:{operator:operator_code,category:category,amount:amount},
