...
<div class="row">
    ...
    <div class="panel mb20 panel-default panel-hovered dropdown"> <i class="ion ion-ios-body text-success"></i> <strong>192+</strong> <br/>
      ...
      <ul class="dropdown-menu">
       <!-- <li><a href="<?php echo base_url()?>index/channel_partner/add_agent" class="l">Add an Agents</a></li>
        ...
        <li><a href="<?php echo base_url()?>channel_partner/add_sp">Add Service Providers</a></li>
        <li><a href="<?php echo base_url()?>channel_partner/total_agents_new">Total Agents</a></li>
        <li><a href="<?php echo base_url()?>channel_partner/total_sp"> Toatal service Providers</a></li>
  ...
  <div class="col-md-2 text-center">
    <div class="panel mb20 panel-default panel-hovered"> <i class="ion ion-person text-danger"></i> <strong>40</strong><br/>
      <a href="<?php echo base_url()?>index/channel_partner/partner" class="btn btn-danger btn-xs mt15 waves-effect">Add Partner</a> </div>
  </div>
  <div class="col-md-2 text-center">
