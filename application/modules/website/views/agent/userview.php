      ...
      <div class="panel-body">
        <?php echo form_open('Agent/add_user','method="post" id="agentuser_form" class="form-horizontal"')?>
		 <div class="form-group">
               ...
               <div class="col-sm-8">
              		<label class="control-label col-sm-4"><?php echo $userlist[0]["customer_id"]?></label>
              </div>
          </div>
          ...
          <div class="form-group">
               ...
               <div class="col-sm-8">
              		<label class="control-label col-sm-4"><?php echo $userlist[0]["name"]?></label>
              </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-8">
                <label class="control-label col-sm-4"><?php echo $userlist[0]["email_id"]?></label>
            </div>
          </div>
          <div class="form-group">
              <label class="control-label col-sm-4">Mobile No:</label>
            <div class="col-sm-8">
              <label class="control-label col-sm-4"><?php echo $userlist[0]["mobile"]?></label>
            </div>
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-8">
               <label class="control-label col-sm-4"><?php echo $userlist[0]["address"]?></label>
            </div>
          </div>
           ...
           <div class="form-group">
            ...
            <div class="col-sm-8">
               <label class="control-label col-sm-4"><?php echo $userlist[0]["pincode"]?></label>
            </div>
          </div>
           <div class="form-group">
              <label class="control-label col-sm-4">City:</label>
            <div class="col-sm-8">
               <label class="control-label col-sm-4"><?php echo $userlist[0]["city_name"]?></label>
            </div>
          </div>
           <div class="form-group">
              <label class="control-label col-sm-4">District:</label>
            <div class="col-sm-8">
               <label class="control-label col-sm-4"><?php echo $userlist[0]["district_name"]?></label>
            </div>
          </div>
		  ...
		  <div class="form-group">
            ...
            <div class="col-sm-8">
               <label class="control-label col-sm-4"><?php echo $userlist[0]["doj"]?></label>
            </div>
          </div>
		  ...
		  <div class="form-group">
            ...
            <div class="col-sm-8">
               <label class="control-label col-sm-4"><?php echo date("d.m.y h:i:s",strtotime($userlist[0]["lupdate"]));?></label>
            </div>
          </div>
		  
		   <div class="form-group">
              <label class="control-label col-sm-4">Wallet:</label>
            <div class="col-sm-8">
               <label class="control-label col-sm-4">INR <?php echo number_format($userlist[0]["waller"],2);?></label>
            </div>
          </div>
