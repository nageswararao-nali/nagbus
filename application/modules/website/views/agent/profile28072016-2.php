...
<!--          <div class="col-md-2">
        ...
        <div class="row" style="margin-top:20px">
          ...
          <div class="col-md-4">
            ...
            <input type="text" class="form-control" name="city" id="geocomplete" value="<?php echo @$profile_info->City;?>" readonly required>
        ...
        <div class="row" style="margin-top:20px">
          ...
          <div class="col-md-4">
            ...
            <input type="text" class="form-control" name="postalcode" id="postalcode" value="<?php echo @$profile_info->Postal_code;?>" readonly required>
          </div>
        </div>
