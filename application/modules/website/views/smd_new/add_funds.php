        ...
        $("#add_funds").validate({
            ...
            messages: {
                amount: {
					...
					minStrict: "Amount should be greater than 50"
                },
                reference_number: {
...
<div class="row">
    <div class="col-md-8 col-md-offset-1">
        <div class="panel panel-default panel-hovered panel-stacked mb30">
            ...
            <div class="panel-body">
                <div class="row">
                    <div class="col-md-12">
                        <form class="form-horizontal" name="add_funds" id="add_funds" action="<?php echo base_url(); ?>smd/add_funds" method="post" enctype="multipart/form-data" >
                            <div class="form-group">
                                <label class="control-label col-sm-4" for="add_money">Add money to Laabus wallet</label>
                                <?php
								if($this->session->userdata('wallet_error'))
								{
									echo "<b style='color:red'>".$this->session->userdata('wallet_error')."</b>";
									unset($_SESSION['wallet_error']);
				$this->session->unset_userdata('wallet_error');
	...
	<div class="col-md-3">
					<b>LAABUS BANK DETAILS:</b><br>

					34785902059<br>
Varini info systems pvt ltd.<br>
SBI<br>
Madinaguda<br>
Hyderabad<br>
