...
<h4>Your Order Details:</h4>
 ...
 <div class="ibox-content">
				...
				<?php echo form_open(base_url() . 'smd/Orders', array('class' => 'form-horizontal', 'id' => 'Orders')); ?>
			...
			?>
                            <tr>
                                ...
                                <td>
									...
									<?php
									if( strtotime($value["dateof_Booking"]) >= strtotime(date('Y-m-d H:i:s'))  )
									{
									?>
									<a href="<?php echo base_url() ?>user/PassengerList/<?php echo $value['bookingKey']?>/<?php echo $value["date_of_Jrny"]?>">
                                    Cancel Ticket
                                    </a>
									<?php  }
									?>
