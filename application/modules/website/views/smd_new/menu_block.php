<style>
.panel-hovered-new { min-height:auto !important}
</style>
<?php
...
else
{
	...
	else
	{
		if($sub_status == 0 )
		{
			...
			$sub_txt = "SMD In order to continue avail services, Please pay Pending Subscription Amount INR ".$pend_amt. ' and your wallet will  refilled with INR '.$subscrptions['subscription_wallet_amt'];
		}
	}
}
//check whether Agent pays Subscription Amount or not
...
<div class="row">
<div class="col-md-1">
    <div class="panel panel-default mb20 mini-box panel-hovered panel-hovered-new">
      <div class="panel-body" style="height:80px; padding:0px;">
        <div class="clearfix">
          <div class="text-center">
            <a href="<?php echo base_url()?>"><img alt="home" src="<?php echo base_url()?>images/home1.jpg" style="width:30px; height:30px;margin-top:30px"></a>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="col-md-9">
    <div class="panel mb20 panel-default panel-hovered panel-hovered-new">
  ...
  <div class="col-md-2">
    <div class="panel panel-default mb20 mini-box panel-hovered panel-hovered-new">
      <div class="panel-body prod-box" style="height:40px; padding:0px;">
        <div class="clearfix">
      ...
      <div class="panel-footer clearfix panel-footer-sm panel-footer-success"  style="padding:14px; text-align:center;">
		...
		<?php /*?> <h5 class="mb0" style="margin-top:-6px; margin-left:-10px; margin-right:-10px;">Joining Bonus&nbsp;<i class="fa fa-inr" style="font-size:14px"></i><?php echo $off_amt;?></h5>
		  <h5 class="mb0" style="margin-top:-6px; margin-left:-10px; margin-right:-10px;">Total Wallet Bonus&nbsp;<i class="fa fa-inr" style="font-size:14px"></i><?php echo $off_amt_wt;?></h5><?php */?>
      </div>
    </div>
  </div>
</div>
...
<div class="row">
    ...
    <div class="panel mb20 panel-default panel-hovered dropdown"> <i class="ion ion-ios-body text-success"></i> <strong><?php //echo count($userlist);?></strong> <br/>
      ...
      <ul class="dropdown-menu">
        <li><a href="<?php echo base_url('smd/profile')?>">Edit Profile</a></li>
      </ul>
    </div>
  </div>
  ...
  <div class="col-md-2 text-center">
    <div class="panel mb20 panel-default panel-hovered dropdown"> <i class="ion ion-ios-body text-success"></i> <strong><?php //echo count($userlist);?></strong> <br/>
      ...
      <ul class="dropdown-menu">
        <li><a href="<?php echo base_url('smd/user')?>">Add an User</a></li>
        <!--<li><a href="<?php echo base_url('smd/services')?>">Add Services</a></li>-->
        <li><a href="<?php echo base_url('smd/users_list')?>">Users List</a></li>
...
<!--  <div class="col-md-2 text-center">
  ...
  <div class="col-md-2 text-center">
    <div class="panel mb20 panel-default panel-hovered dropdown"> <i class="ion ion-stats-bars text-primary"></i> <strong></strong><br/>
	  ...
	  <a href='<?php echo base_url()?>smd/Orders' style='color:#fff'>Reports </a><span class="caret"></span></button>
     <ul class="dropdown-menu">
   <li><a href="<?php echo base_url()?>smd/Orders">Orders Reports</a></li>
	 <li><a href="<?php echo base_url()?>smd/Cashback">Cashback Reports</a></li>
  ...
  <div class="col-md-2 text-center">
    <div class="panel mb20 panel-default panel-hovered dropdown"> <i class="ion ion-stats-bars text-primary"></i> <strong></strong><br/>
      <button class="btn btn-primary btn-xs mt15 waves-effect dropdown-toggle" type="button" data-toggle="dropdown">
	  <a href='<?php echo base_url()?>smd/Orders' style='color:#fff'>Mark as Credit Reports </a><span class="caret"></span></button>
     <ul class="dropdown-menu">
	 <li><a href="<?php echo base_url()?>smd/Creditorders">Mark as Credit Reports</a></li>
  ...
  <div class="col-md-2 text-center">
    <div class="panel mb20 panel-default panel-hovered dropdown"> <i class="fa fa-pie-chart text-pink"></i> <strong>&nbsp;</strong><br/>
      ...
      <!--<ul class="dropdown-menu">
        <li><a href="<?php echo base_url('smd/add_funds')?>">Add Funds</a></li>
        <li><a href="<?php echo base_url('smd/wallet_list')?>">Wallet List</a></li>
        <li><a href="<?php echo base_url('smd/agent_users_list')?>">Users Wallet Listing</a></li>
      </ul>-->

	  <ul class="dropdown-menu">
        <li><a href="<?php echo base_url('smd/add_funds')?>">Add Funds</a></li>
        <li><a href="<?php echo base_url('smd/wallet_list')?>">Wallet List</a></li>
        <li><a href="<?php echo base_url('smd/smd_users_list')?>">Users Wallet Listing</a></li>
		<?php
		if( $is_subscription == 1 )
		{
		?>
        <li><a href="<?php echo base_url('smd/wallet_withdraw')?>">Wallet withdraw</a></li>
		<li><a href="<?php echo base_url('smd/wallet_withdraw_list')?>">Wallet WithDraw History</a></li>
