...
//---------------------------------
	...
	//$message ='Dear #VAL#, You new  Password is #VAL#. thank you for using www.laabus.com For best offers download  app @ https://goo.gl/tjc8mr
	$message ='Dear '.$name.', You new  Password is '.$password.'. thank you for using www.laabus.com For best offers download  app @ https://goo.gl/tjc8mr';
