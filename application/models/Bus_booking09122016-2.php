...
class Bus_Booking extends CI_Model {
    ...
    public function cancelationData($data1,$data2){
		...
		$message ='your ticket for '.$fromcity.' to '.$to_city.' on '.$date_of_Jrny.' is booked on laabus. seat no '.$seats_no.' with PNR '.$bus_id.' has been cancelled successfully . Thank you for using www.laabus.com';
		//SMS
//Code using curl
