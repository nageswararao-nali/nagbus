...
<script>
 $(function() {
    ...
    <li>
      <div class="site-logo visible-xs"> <a href="javascript:;" class="text-uppercase h3"> <span class="text"><img alt="Laabus" src="http://laabus.com/images/small_logo.png"></span> </a> </div>
    </li>
