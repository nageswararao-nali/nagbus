...
<div class="col-md-1">
    ...
    <a href="<?php echo base_url()?>channelpartner/index"><img alt="home" src="<?php echo base_url()?>images/home1.jpg" style="width:30px; height:30px;"></a>
          </div>
        </div>
      </div>
    </div>
...
<div class="row">
  <div class="col-md-2 text-center">
    <div class="panel mb20 panel-default panel-hovered dropdown"> <i class="ion ion-ios-body text-success"></i> <strong>192+</strong> <br/>
      ...
      <ul class="dropdown-menu">
        <li><a href="<?php echo base_url()?>channelpartner/Addpartner">Add Partner</a></li>
        <li><a href="<?php echo base_url()?>channelpartner/AddAgent">Add an Agents</a></li>
        <li><a href="<?php echo base_url()?>channelpartner/Addsp">Add Service Providers</a></li>
        <li><a href="<?php echo base_url()?>channelpartner/TotalAgents">Total Agents</a></li>
        <li><a href="<?php echo base_url()?>channelpartner/Totalsp"> Toatal service Providers</a></li>
        <li><a href="<?php echo base_url()?>channelpartner/TotalUsers">Total Users</a></li>
      </ul>
    </div>
  </div>
  <div class="col-md-2 text-center">
    <div class="panel mb20 panel-default panel-hovered dropdown"> <i class="ion ion-person text-danger"></i> <strong>40</strong><br/>
      <button class="btn btn-danger btn-xs mt15 waves-effect dropdown-toggle" type="button" data-toggle="dropdown">approvals <span class="caret"></span></button>
      <ul class="dropdown-menu">
        <li><a href="<?php echo base_url()?>channelpartner/agentApproval">Agent Approvals</a></li>
        <li><a href="<?php echo base_url()?>channelpartner/spApproval">Service Provider Approvals</a></li>
      </ul>
     </div>
  </div>
  <div class="col-md-2 text-center">
    <div class="panel mb20 panel-default panel-hovered dropdown"> <i class="fa fa-inr text-info"></i> <strong>100+</strong><br/>
      ...
      <ul class="dropdown-menu">
        <li><a href="<?php echo base_url()?>channelpartner/AgentEarning">By Agents</a></li>
        <li><a href="<?php echo base_url()?>channelpartner/spEarning">By Service Providers</a></li>
        <li><a href="<?php echo base_url()?>channelpartner/ServicesEarning">By Services</a></li>
        <li><a href="<?php echo base_url()?>channelpartner/TotalEarning">Total Earnings</a></li>
      </ul>
    </div>
  </div>
  <div class="col-md-2 text-center">
    <div class="panel mb20 panel-default panel-hovered dropdown"> <i class="ion ion-stats-bars text-primary"></i> <strong>55</strong><br/>
      ...
      <ul class="dropdown-menu">
        <li><a href="<?php echo base_url()?>channelpartner/Dailyreport">Daily Report</a></li>
        <li><a href="<?php echo base_url()?>channelpartner/Monthlyreport">Monthly Report</a></li>
        <li><a href="<?php echo base_url()?>channelpartner/Agentwise">Agent wise</a></li>
        <li><a href="<?php echo base_url()?>channelpartner/spreport">service Provider</a></li>
        <li><a href="<?php echo base_url()?>channelpartner/ReversalsCancels">Reversals and Cancelations</a></li>
      </ul>
    </div>
  </div>
  ...
  <div class="col-md-2 text-center">
    <div class="panel mb20 panel-default panel-hovered dropdown"> <i class="fa fa-pie-chart text-purple"></i> <strong>73</strong><br/>
      ...
      <ul class="dropdown-menu">
        <li><a href="<?php echo base_url()?>channelpartner/Invoice">New Invoice</a></li>
        <li><a href="<?php echo base_url()?>channelpartner/Invoice">All Invoices</a></li>
        <li><a href="<?php echo base_url()?>channelpartner/Invoice">Paid Invoices</a></li>
      </ul>
    </div>
  </div>
  <div class="col-md-2 text-center">
    <div class="panel mb20 panel-default panel-hovered"> <i class="ion ion-ios-chatboxes-outline text-pink"></i> <strong>32</strong><br/>
    <a href="<?php echo base_url()?>channelpartner/Feedback" type="button" class="btn btn-pink btn-xs mt15 waves-effect">Feedback</a>
    </div>
  </div>
</div>
...
$(document).on('click','.email',function(){
	location.href='<?php echo base_url()?>channel_partner/email'
});
$(document).on('click','.calendar',function(){
	location.href='<?php echo base_url()?>channel_partner/calender'
});
