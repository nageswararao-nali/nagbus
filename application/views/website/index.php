  ...
  <div class="row"  <?php
    ...
    <div class="col-sm-4">
      <div class="panel mb20 panel-default panel-hovered">
        ...
        <div class="panel-body"> <?php echo form_open('Welcome/register','id="recForm" method="post" autocomplete="off"')?>
          ...
          <div class="form-group">
            <input type="text" class="form-control fetch_network num_only" name="mobile_no" id="mobile_no" placeholder="Mobile no" autofocus required>
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            <input type="text" class="form-control rcAmount rcamtoffers" placeholder="Recharge Amount" name="rcAmount">
          </div>
           <div class="form-group">
