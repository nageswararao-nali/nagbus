...
<div class="col-md-1">
    ...
    <a href="<?php echo base_url()?>index/agent/dashboard"><img alt="home" src="<?php echo base_url()?>images/home1.jpg" style="width:30px; height:30px;"></a>
          </div>
        </div>
      </div>
    </div>
...
<div class="row">
  <div class="col-md-2 text-center">
    <div class="panel mb20 panel-default panel-hovered dropdown"> <i class="ion ion-ios-body text-success"></i> <strong>192+</strong> <br/>
      ...
      <ul class="dropdown-menu">
        <li><a href="<?php echo base_url()?>Index/agent/add_user">Add an User</a></li>
        <li><a href="<?php echo base_url()?>Index/agent/services">Add Services</a></li>
      </ul>
    </div>
  </div>
  <div class="col-md-2 text-center">
  ...
  <div class="col-md-2 text-center">
    <div class="panel mb20 panel-default panel-hovered dropdown"> <i class="ion ion-stats-bars text-primary"></i> <strong>55</strong><br/>
      <button class="btn btn-primary btn-xs mt15 waves-effect dropdown-toggle" type="button" data-toggle="dropdown"><a href="<?php echo base_url()?>agent/Orders">Reports</a> <span class="caret"></span></button>
     <!-- <ul class="dropdown-menu">
  ...
  <div class="col-md-2 text-center">
    <div class="panel mb20 panel-default panel-hovered dropdown"> <i class="fa fa-pie-chart text-pink"></i> <strong>73</strong><br/>
      <button class="btn btn-pink btn-xs mt15 waves-effect dropdown-toggle" type="button" data-toggle="dropdown">Invoices <span class="caret"></span></button>
      <ul class="dropdown-menu">
        <li><a href="<?php echo base_url()?>Index/agent/invoice">New Invoice</a></li>
        <li><a href="<?php echo base_url()?>Index/agent/invoice">All Invoices</a></li>
        <li><a href="<?php echo base_url()?>Index/agent/invoice">Paid Invoices</a></li>
      </ul>
    </div>
  </div>
  <div class="col-md-2 text-center">
