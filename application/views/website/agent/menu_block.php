...
$offerdetails = getjoiningoffersWalletDetails($role_id,'');
  ...
  <div class="col-md-10">
    <div class="panel mb20 panel-default panel-hovered">
      <div class="dash-head clearfix mt10 mb10">
		...
		<span style="color:green"><b>JOINING OFFER:</b>  GET Rs. 100 by Adding Minimum amount of Rs. 500 in Wallet.</span>
  ...
  <div class="col-md-1">
    <div class="panel panel-default mb20 mini-box panel-hovered">
      ...
      <div class="panel-footer clearfix panel-footer-sm panel-footer-success"  style="height:35px;">
        <h5 class="mb0" style="margin-top:-6px; margin-left:-10px; margin-right:-10px;"><i class="fa fa-inr" style="font-size:14px"></i>&nbsp;<?php echo $wallet_amount;?></h5>
      </div>
    </div>
  </div>
</div>
