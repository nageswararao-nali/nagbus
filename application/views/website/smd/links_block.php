...
<div class="col-md-1">
    ...
    <a href="<?php echo base_url()?>index/smd/dashboard"><img alt="home" src="<?php echo base_url()?>images/home1.jpg" style="width:30px; height:30px;"></a>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="col-md-10">
    ...
    <!--<div class="col-md-2">
    <a href="<?php echo base_url()?>index/smd/dashboard"><i class="ion ion-home" style="text-align:center; font-size:36px;"></i></a>
    </div>-->
...
<div class="row">
  <div class="col-md-2 text-center">
    <div class="panel mb20 panel-default panel-hovered dropdown"> <i class="ion ion-ios-body text-success"></i> <strong>192+</strong> <br/>
      ...
      <ul class="dropdown-menu">
        <li><a href="<?php echo base_url()?>index/smd/add_agent" class="l">Add an Agents</a></li>
        <li><a href="<?php echo base_url()?>index/smd/add_sp">Add Service Providers</a></li>
        <li><a href="<?php echo base_url()?>index/smd/total_agents">Total Agents</a></li>
        <li><a href="<?php echo base_url()?>index/smd/total_sp"> Toatal service Providers</a></li>
        <li><a href="<?php echo base_url()?>index/smd/total_users">Total Users</a></li>
      </ul>
    </div>
  </div>
  <div class="col-md-2 text-center">
    <div class="panel mb20 panel-default panel-hovered"> <i class="ion ion-person text-danger"></i> <strong>40</strong><br/>
      <a href="<?php echo base_url()?>index/smd/partner" class="btn btn-danger btn-xs mt15 waves-effect">Add Partner</a> </div>
  </div>
  <div class="col-md-2 text-center">
    <div class="panel mb20 panel-default panel-hovered dropdown"> <i class="fa fa-inr text-info"></i> <strong>100+</strong><br/>
      ...
      <ul class="dropdown-menu">
        <li><a href="<?php echo base_url()?>index/smd/agent_earning">By Agents</a></li>
        <li><a href="<?php echo base_url()?>index/smd/sp_earning">By Service Providers</a></li>
        <li><a href="<?php echo base_url()?>index/smd/services_earning">By Services</a></li>
        <li><a href="<?php echo base_url()?>index/smd/total_earnings">Total Earnings</a></li>
      </ul>
    </div>
  </div>
  <div class="col-md-2 text-center">
    <div class="panel mb20 panel-default panel-hovered dropdown"> <i class="ion ion-stats-bars text-primary"></i> <strong>55</strong><br/>
      ...
      <ul class="dropdown-menu">
        <li><a href="<?php echo base_url()?>Index/smd/reports/daily_report">Daily Report</a></li>
        <li><a href="<?php echo base_url()?>Index/smd/reports/monthly_report">Monthly Report</a></li>
        <li><a href="<?php echo base_url()?>Index/smd/reports/agent_wise">Agent wise</a></li>
        <li><a href="<?php echo base_url()?>Index/smd/reports/sp_report">service Provider</a></li>
        <li><a href="<?php echo base_url()?>Index/smd/reports/reversals_cancels">Reversals and Cancelations</a></li>
      </ul>
    </div>
  </div>
  ...
  <div class="col-md-2 text-center">
    <div class="panel mb20 panel-default panel-hovered dropdown"> <i class="fa fa-pie-chart text-purple"></i> <strong>73</strong><br/>
      ...
      <ul class="dropdown-menu">
        <li><a href="<?php echo base_url()?>Index/smd/invoice_list">New Invoice</a></li>
        <li><a href="<?php echo base_url()?>Index/smd/invoice_list">All Invoices</a></li>
        <li><a href="<?php echo base_url()?>Index/smd/invoice_list">Paid Invoices</a></li>
      </ul>
    </div>
  </div>
  <div class="col-md-2 text-center">
    <div class="panel mb20 panel-default panel-hovered"> <i class="ion ion-ios-chatboxes-outline text-pink"></i> <strong>32</strong><br/>
    <a href="<?php echo base_url()?>Index/smd/feedback" type="button" class="btn btn-pink btn-xs mt15 waves-effect">Feedback</a>
    </div>
  </div>
</div>
...
$(document).on('click','.email',function(){
	location.href='<?php echo base_url()?>index/smd/email'
});
$(document).on('click','.calendar',function(){
	location.href='<?php echo base_url()?>index/smd/calender'
});
