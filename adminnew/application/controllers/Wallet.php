...
class Wallet extends CI_Controller {
	...
	public function received($id='',$customer_id='') {		
        $wallet_history = $this->wallet_history->get_wallet_receive_details($id);
        $_data['wallet_history'] = $wallet_history;
		$_data['customer_id'] = $customer_id;
        $this->load->view('admin_template/Header');
        $this->load->view('dashboard/wallet/received', $_data);
        $this->load->view('admin_template/Footer');
    }
...
//---------------------------------
    ...
    public function changewithdrawnstatus()
    {
    	//echo "Hi";die;
    	$wallet_withdraws = $this->wallet_history->changewithdrawnstatus($_REQUEST["id"],$_REQUEST["status"]);
    	//print_r($_REQUEST);die;
    	echo "Success";die;
    }
    
    public function deletewalletwithdrawnrecord()
    {
    	//echo "Hi";die;
    	$wallet_withdraws = $this->wallet_history->deletewalletwithdrawnrecord($_REQUEST["id"]);
    	//print_r($_REQUEST);die;
    	echo "Success";die;
    }
	
	public function deletewallethistoryrecord()
    {
    	//echo "Hi";die;
    	$wallet_withdraws = $this->wallet_history->deletewallethistoryrecord($_REQUEST["id"]);
    	//print_r($_REQUEST);die;
    	echo "Success";die;
    }
