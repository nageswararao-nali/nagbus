    ...
    <div class="row">
        <div class="col-lg-12">
				...
				?>
						...
						<div class="form-group" style="margin-top:16px">
                           ...
                           <input type="text"  placeholder=" EXACT X amount in wallet "  name="org_amount[0]"  value='' >
						    ...
						    <input type="hidden"    name="org_amount_max[0]"  value='' >
            ...
            <hr>
									...
									<div class="form-group" style="margin-top:16px">
                            <label class="col-lg-2 control-label">Add <span style='color:red'>UPTO</span> ‘x’ funds get ‘y%’ of additional</label>
                            <div class="col-lg-10">
                          ...
                          <input type="hidden"   name="offer_type[<?php echo $i ?>]"  value='UPTO' >
                           ...
                           <input type="text"  placeholder=" Minimun X amount in wallet "  name="org_amount[<?php echo $i?>]"  value='' >
						 ...
						 <div class="form-group col-lg-3">
                           ...
                           <input type="text"  placeholder=" Maximum X amount in wallet "  name="org_amount_max[<?php echo $i?>]"  value='' >
            ...
            <tbody class="tblCategories2" >
			 ...
			 <td><?php echo $value["promo_code"]?></td>
			  <td><?php echo $value["offer_type"]?></td>
                ...
                <td>
				<?php 
				if($value["offer_type"] == "EXACT")
				{
				echo $value["org_amount"];
				}
				else
				{
				echo "From ".$value["org_amount"]." to ".$value["org_amount_max"];	
				}
				?>
				</td>      
