        ...
        <div class="col-lg-12">
			   ...
			   <div class="ibox-content">	
				...
				?>
						...
						<div class="form-group" style="margin-top:16px">
                           ...
                           <input type="text"  placeholder=" EXACT X amount in wallet " class="groupOfTexbox" name="org_amount[0]"  value='' >
						 ...
						 <div class="form-group col-lg-4">
						   ...
						   <input type="text"  placeholder="GET Y additional amount " class="groupOfTexbox" name="add_amount[0]"  value='' >
            ...
            <hr>
                          ...
                          <input type="hidden"   name="offer_type[<?php echo $i ?>]"  value='UPTO' >
                           ...
                           <input type="text"  placeholder=" Add Upto X amount in wallet " class="groupOfTexbox" name="org_amount[<?php echo $i?>]"  value='' >
						 ...
						 <div class="form-group col-lg-4">
						   ...
						   <input type="text"  placeholder="GET Y additional amount " class="groupOfTexbox" name="add_amount[<?php echo $i?>]"  value='' >
