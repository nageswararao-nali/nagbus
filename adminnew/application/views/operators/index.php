                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-10">
                                <select class="form-control" name="categoryid">
                                    <option value="">Select Category</option>										<?php							$cat = json_decode($categorydata);							foreach($cat as $data){								?>			                <option value="<?php echo $data->cat_id; ?>"><?php echo $data->cat_name; ?></option>	                    	<?php									}							?>
                                </select>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-lg-10">
                                <input type="text" placeholder="Enter Operator Name" class="form-control" name="operator_name">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-lg-2 control-label">Operator code</label>
                            <div class="col-lg-10">
                                <input type="text" placeholder="Enter Operator Code" class="form-control" name="operator_code">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-lg-2 control-label">Description</label>
                            <div class="col-lg-10">
                                <input type="text" placeholder="Enter Operator Description" class="form-control" name="description">
                            </div>
                        </div>
                        <div class="form-group">
...
<!--                                <td><font color="green" ng-show="category.enable == 1">Active</font>
                                ...
                                <td><a href="operators/edit_operators/{{operator.sub_cat_id}}">Edit</a> - <a href="" class="btn btn-white btn-sm deleteAction" title="Click me to delete" ng-click="delete(operator.sub_cat_id)"><i class="fa fa-times"></i> Delete</a></td>
                            </tr>
                        </tbody>
                    </table>
                </div>
