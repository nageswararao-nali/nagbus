<nav class="navbar-default navbar-static-side" role="navigation">
    <div class="sidebar-collapse">
        <ul class="nav metismenu" id="side-menu">
            ...
            <li <?= ($this->uri->segment(1) == "dashboard" && !empty($this->uri->segment(2))) ? 'class="active"' : ''; ?>> <a href="#"><i class="fa fa-bell"></i> <span class="nav-label">Approvals</span><span class="fa arrow"></span></a>
                <ul class="nav nav-second-level collapse">
...
<!--                    <li <?= $this->uri->segment(2) == "Food_Courts" ? 'class="active"' : ''; ?>><a href="<?= base_url() ?>Admin/Approvals/Food_Courts" title="Hotels and Restarents">Food Courts</a></li>
            ...
            <!--<li <?= ($this->uri->segment(1) == "wallet" ) ? 'class="active"' : ''; ?>> <a href="<?= base_url() ?>wallet"><i class="fa fa-google-wallet"></i> <span class="nav-label">Wallet History</span></a> </li>-->
			   ...
			   <li <?= ($this->uri->segment(1) == "wallet" && !empty($this->uri->segment(2))) ? 'class="active"' : ''; ?>> <a href="#"><i class="fa fa-google-wallet"></i> <span class="nav-label">Wallet</span><span class="fa arrow"></span></a>
                <ul class="nav nav-second-level collapse">
