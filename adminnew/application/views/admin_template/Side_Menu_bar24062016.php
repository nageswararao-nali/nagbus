...
<!--                    <li <?= $this->uri->segment(2) == "Food_Courts" ? 'class="active"' : ''; ?>><a href="<?= base_url() ?>Admin/Approvals/Food_Courts" title="Hotels and Restarents">Food Courts</a></li>
            ...
            <li <?= $this->uri->segment(2) == "Commission_Setup" ? 'class="active"' : ''; ?>><a href="javascript:;"><i class="fa fa-inr"></i> <span class="nav-label">Offers</span><span class="fa arrow"></span></a>
                <ul class="nav nav-second-level collapse">
                    ...
                    <li <?= $this->uri->segment($this->uri->total_segments()) == "Commission_Setup" ? 'class="active"' : ''; ?>><a href="<?= base_url() ?>dashboard/Commission">Join & Refer(Mobile APP)</a></li>
                   
                    <li <?= $this->uri->segment($this->uri->total_segments()) == "distribute" ? 'class="active"' : ''; ?>><a href="#">Join & Very First Order</a></li>
					
					<li <?= $this->uri->segment($this->uri->total_segments()) == "distribute" ? 'class="active"' : ''; ?>><a href="#">Wallet</a></li>
