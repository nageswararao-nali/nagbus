...
<!--                                <td>-</td>-->
                                ...
                                <td><a href="/laabus/adminnew/Categories/edit_category/{{category.cat_id}}">Edit</a> - <a href="" class="btn btn-white btn-sm deleteAction" title="Click me to delete" ng-click="delete(category.cat_id)" confirm="Are you sure, {{name}}?"><i class="fa fa-times"></i> Delete</a></td>
                            </tr>
                        </tbody>
                    </table>
                </div>
