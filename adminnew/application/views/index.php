...
<table width="80%" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td width="33%" height="80" align="center" valign="middle" bgcolor="#Cfecfcf"><h4><?php  if(!empty($month_wallet[0]['totwallet'])) echo $month_wallet[0]['totwallet'] ; else echo "0.00";?>/- Rs</h4></td>
    <td width="33%" height="80" align="center" valign="middle" bgcolor="#Cfecfcf"><h4><?php  if(!empty($today_wallet[0]['totwallet'])) echo $today_wallet[0]['totwallet'] ; else echo "0.00";?>/- Rs</h4></td>
  </tr>
  ...
  <tr>
    <td width="33%" height="40" align="center" valign="middle" bgcolor="#CFECFC"><h4><?php echo isset($today_wallet_users[0]['totwallet'])?$today_wallet_users[0]['totwallet']:0;?></h4></td>
    <td width="33%" height="0" align="center" valign="middle" bgcolor="#CFECFC"><h4><?php echo isset($today_wallet_agents[0]['totwallet'])?$today_wallet_agents[0]['totwallet']:0;?></h4></td>
  ...
  $agent_tot = 0;
  $chnl_part = 0;
  if(!empty($users_today))
  {
	 foreach($users_today as $key =>$value)
	 {
		   $cnt+=$value['cnt'];
		 if($value["role_id"] == 2 )
		 {
  ...
  ?>
  <tr>
    <td height="80" align="center" valign="middle" bgcolor="#CFECFC"><?php echo $users_tot?></td>
