                            ...
                            <?php foreach ($channel as $chrole) { ?>
                                <tr id="chnl<?php echo $chrole['user_id']; ?>">
                                    ...
                                    <td><!-- <a href="<?php echo base_url()?>dashboard/add_user_money/<?php echo $chrole['user_id']; ?>/channel_partner">Add Money</a> - -->
                                        <a href="<?php echo base_url()?>dashboard/update_channel_partner/<?php echo $chrole['user_id']; ?>">Edit</a> - <a href="javascript:;"  data-id="<?php echo $chrole['user_id']; ?>" class="btn btn-white btn-sm deleteAction" title="Click me to delete" ><i class="fa fa-times"></i> Delete</a></td>
                                </tr>
                            <?php } ?>
                        </tbody>
                    </table>
