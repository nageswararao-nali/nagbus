                            ...
                            <?php foreach ($channel as $chrole) { ?>
                                <tr>
                                    ...
                                    <td><!-- <a href="<?php echo base_url()?>dashboard/add_user_money/<?php echo $chrole['user_id']; ?>/channel_partner">Add Money</a> - -->
                                        <a href="<?php echo base_url()?>dashboard/update_channel_partner/<?php echo $chrole['user_id']; ?>">Edit</a> - <a href="#" class="btn btn-white btn-sm deleteAction" title="Click me to delete" data-module="{{module.module_id}}"><i class="fa fa-times"></i> Delete</a></td>
                                </tr>
                            <?php } ?>
                        </tbody>
                    </table>
