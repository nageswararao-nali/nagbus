        ...
        <div class="col-lg-6">
            <div class="ibox-content">
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-8">
                        <input type="text" id="details" placeholder="Product Details" class="form-control"/>
                        <br>
                    </div>
                </div>
            </div>
...
<script>
 ...
 //	console.log("called");
 	var title = $('#title').val();
        var StartDateOldFormat = $('#startDate').val();
        ...
        var EndDateOldFormat = $('#endDate').val();
