                ...
                <div class="row">
                 <div class="col-sm-4">
	                 <div class="form-group">
                        ...
                        <input type="text" class="form-control num_only" placeholder="Enter Minimum value" name="purchase_value" required ng-model="purchasevalue"/>
                        </div>
                      </div>
                  <div class="col-sm-4">
                    ...
                    <div class="row">
                    	<div class="col-sm-4">
                        	<div class="form-group">
                                <select class="form-control" name="discount" required ng-model="dis_type">
                         ...
                         <div class="col-sm-8">
                         	<div class="form-group">
	                            <input type="text" class="form-control num_only" placeholder="Enter Discount value" name="purchase_discount" required ng-model="discountvalue"/>
                            </div>
                         </div>
                        </div>
                    </div>
