                    ...
                    <table class="table table-hover" id="example">
                        ...
                        <tbody class="tblCategories">
                            ...
                            foreach ($wallet_history as $wallet) {
                                ?>
                                 <tr id="chnl<?php echo $wallet['wallet_history_id']?>">
                                    ...
                                    <td>
                                        ...
                                        <a href="javascript:;"  data-id="<?php echo $wallet['wallet_history_id']; ?>" class="btn btn-white btn-sm deleteAction ddelete" title="Click me to delete" ><i class="fa fa-times"></i> Delete</a>
		...
		if(confirm('Are you sure want to delete this record?'))
			{
				...
				$.ajax({
				url: 'http://laabus.com/adminnew/Wallet/deletewallethistoryrecord',
				data: {id:id},
				type: 'POST',
				cache: false,
