...
$cnt++;								
				  ...
				  <input type="text" class="input-sm" size="4" name="our_comm_value<?php echo $value["id"]?>" id="our_comm_valuel<?php echo $value["id"]?>" value="" />
								...
								<select class="input-sm" name="agent_comm_type<?php echo $value["id"]?>"
								id="agent_comm_typel<?php echo $value["id"]?>">
                    <option value=""></option>
                    <option value="INR" >Rs</option>
                    <option value="PEC" >%</option>
                  </select>	
...
<span id="edit_dis_comml<?php echo $value["id"]?>" style='display:none'>
				  ...
				  <input type="text" class="input-sm" size="4" name="dis_comm_value<?php echo $value["id"]?>" id="dis_comm_valuel<?php echo $value["id"]?>" value="" />
                                ...
                                <td><a class="editcommlimoffer" data-subcat="<?php echo $value["idsubcat"]?>" id="<?php echo $value["id"]?>" href='javascript:;'>Edit</a>&nbsp;&nbsp;<a onclick="return confirm('Are you sure?')" href='deletecommlimoffer?id=<?php echo $value["id"]?>'>Delete</a></td>
								</tr>
							<?php }
							?>
		...
		$(document).on('click','.editcommlimoffer', function(event){	
		  ...
		  success:function(data) {
			...
			else
			{
				...
				our_comm_type = $("#our_comm_typel"+id).val();
				our_comm_value = $("#our_comm_valuel"+id).val();
				agent_comm_type = $("#agent_comm_typel"+id).val();
				agent_comm_value = $("#agent_comm_valuel"+id).val();
				agent_ref_comm_type = $("#agent_ref_comm_typel"+id).val();
				agent_ref_comm_value = $("#agent_ref_comm_valuel"+id).val();
				mark_comm_type = $("#mark_comm_typel"+id).val();
				mark_comm_value = $("#mark_comm_valuel"+id).val();
				dis_comm_type = $("#dis_comm_typel"+id).val();
				dis_comm_value = $("#dis_comm_valuel"+id).val();
				$.ajax({
		  url:"http://laabus.com/adminnew/dashboard/update_offer_comm_by_id",
		  data:{id:subcat,our_comm_type:our_comm_type,our_comm_value:our_comm_value,agent_comm_type:agent_comm_type,agent_comm_value:agent_comm_value,agent_ref_comm_type:agent_ref_comm_type,agent_ref_comm_value:agent_ref_comm_value,mark_comm_type:mark_comm_type,mark_comm_value:mark_comm_value,dis_comm_type:dis_comm_type,dis_comm_value:dis_comm_value},
		  success:function(data) {
			 //return data;

			 $("#view_our_comml"+id).show();
				$("#edit_our_comml"+id).hide();				
				ty = $("#our_comm_typel"+id).val();
				if(ty == "INR")
				{
					data = $("#our_comm_valuel"+id).val() + " (INR)";
					$("#view_our_comml"+id).text(data);
				}
				else if(ty == "PEC")
				{
					data = $("#our_comm_valuel"+id).val() + " (%)";
					$("#view_our_comml"+id).text(data);
				}
				else
				{
				...
				$("#edit_agent_comml"+id).hide();
				$("#view_agent_comml"+id).show();
				ty = $("#agent_comm_typel"+id).val();
				if(ty == "INR")
				{
					data = $("#agent_comm_valuel"+id).val() + " (INR)";
					$("#view_agent_comml"+id).text(data);
				}
				else if(ty == "PEC")
				{
					data = $("#agent_comm_valuel"+id).val() + " (%)";
					$("#view_agent_comml"+id).text(data);
				}
				else
				{
				...
				$("#edit_agent_ref_comml"+id).hide();
				$("#view_agent_ref_comml"+id).show();
ty = $("#agent_ref_comm_typel"+id).val();
				if(ty == "INR")
				{
					data = $("#agent_ref_comm_valuel"+id).val() + " (INR)";
					$("#view_agent_ref_comml"+id).text(data);
				}
				else if(ty == "PEC")
				{
					data = $("#agent_ref_comm_valuel"+id).val() + " (%)";
					$("#view_agent_ref_comml"+id).text(data);
				}
				else
				{
				...
				$("#edit_mark_comml"+id).hide();
				$("#view_mark_comml"+id).show();
				ty = $("#mark_comm_typel"+id).val();
				if(ty == "INR")
				{
					data = $("#mark_comm_valuel"+id).val() + " (INR)";
					$("#view_mark_comml"+id).text(data);
				}
				else if(ty == "PEC")
				{
					data = $("#mark_comm_valuel"+id).val() + " (%)";
					$("#view_mark_comml"+id).text(data);
				}
				else
				{
				...
				$("#edit_dis_comml"+id).hide();
				$("#view_dis_comml"+id).show();
				ty = $("#dis_comm_typel"+id).val();
				if(ty == "INR")
				{
					data = $("#dis_comm_valuel"+id).val() + " (INR)";
					$("#view_dis_comml"+id).text(data);
				}
				else if(ty == "PEC")
				{
					data = $("#dis_comm_valuel"+id).val() + " (%)";
					$("#view_dis_comml"+id).text(data);
				}
				else
				{
