<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-sm-6">
        ...
        <ul class="breadcrumb">
            ...
            <li><a href="<?php echo base_url() . 'dashboard/agents/' ?>">Users</a> </li>
...
<div class="wrapper wrapper-content animated fadeInRight">
    <div class="row white-bg">
        <?php echo form_open(base_url() . 'dashboard/update_user/' . $user_details[0]['user_id'], array('class' => 'form-horizontal', 'id' => 'updateAgent')); ?>
