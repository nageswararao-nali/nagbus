...
<div class="wrapper wrapper-content animated fadeInRight">
    <div class="row white-bg">
        <?php echo form_open(base_url() . 'dashboard/userlists/', array('class' => 'form-horizontal', 'id' => 'addAgents')); ?>
                        ...
                        <tbody>
                            <?php foreach ($user_details as $data) { ?>
                                <tr id="chnl<?php echo $data['user_id']; ?>">
                                    <td><a href="<?php echo base_url()?>dashboard/view_user/<?php echo $data['user_id']; ?>"><?php echo $data['customer_id']; ?></a></td>
                                    ...
                                    <td>
									<a href="<?php echo base_url()?>dashboard/update_user/<?php echo $data['user_id']; ?>">Edit</a> - <a href="javascript:;"  data-id="<?php echo $data['user_id']; ?>" class="btn btn-white btn-sm deleteAction" title="Click me to delete" ><i class="fa fa-times"></i> Delete</a></td>
                                </tr>
                            <?php } ?>
                        </tbody>
                    </table>
