...
<div class="wrapper wrapper-content animated fadeInRight">
    <div class="row white-bg">
            ...
            <div class="col-lg-6">
                <div class="ibox-content">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-8">
                            <textarea id="details" name="details" placeholder="Product Details" class="form-control"><?= $offer->more_details?></textarea>
                            <br>
                        </div>
                    </div>
                    <div class="form-group">
		...
		<div class="form-group">
		            ...
		            <div class="col-lg-8">
		                <input type="checkbox" id="buy_now" name="buy_now" value="1" <?= ($offer->buy_now == '1')?'checked':''?>/>
		                <br>
		            </div>
		        </div>
                </div>
