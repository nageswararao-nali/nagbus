      ...
      <div class="ibox float-e-margins">
        <div class="ibox-title">
		 ...
		 <div style="margin-left:40px">
			<b>Search By:</b> <select name="role_id" onchange="document.frm.submit()">
          ...
          <table class="table table-hover" id="example">
			...
			foreach($user_details as $key=>$value)
			{
                ...
                <td><a href="http://laabus.com/adminnew/wallet/received/<?php echo  $value["user_id"]?>/<?php echo  $value["customer_id"]?>">View ALL</a></td>
				</tr>
				<?php
			}
			?>		
