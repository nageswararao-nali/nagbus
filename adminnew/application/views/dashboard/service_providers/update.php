<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-sm-6">
        ...
        <ul class="breadcrumb">
            ...
            <li><a href="<?php echo base_url() . 'dashboard/service_providers/' ?>">Service Providers</a> </li>
            <li class="active"><strong>Update Service Provider</strong></li>
        </ul>
    </div>
</div>
...
<div class="wrapper wrapper-content animated fadeInRight">
    <div class="row white-bg">
        <?php echo form_open(base_url() . 'dashboard/update_service_provider/' . $user_details[0]['user_id'], array('class' => 'form-horizontal', 'id' => 'updateAgent')); ?>
        ...
        <div class="col-lg-6">                
            <div class="ibox-content">
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-8">
                        <?php echo form_dropdown("home_repairs", $home_repairs, $user_details[0]['sub_cat_id'], 'class = "form-control" id = "status"') ?>
                    </div>
                </div>
            </div>
        </div>
