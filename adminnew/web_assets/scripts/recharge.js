$(document).ready(function() {
    ...
    function operators() {
        var ur = baseurl + 'APIS/recharge_api/get_operators';
        $.ajax({
            url: ur,
            success: function(res) {
                var obj = JSON.parse(res);
